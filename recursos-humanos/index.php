...
<body>
	<div class="main">
		<div class="box">
			...
			<div class="uno"><a href="renuncias/" class="btn btn-primary btn-block">Renuncias</a></div>
			...
			<a href="registro-empleados.php" class="btn btn-secondary btn-block">Registrar Empleados</a><br>
